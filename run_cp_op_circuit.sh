...
if [ ${CP_CTRL} -eq 4 ]; then
	...
	${APP_DIR}/src/tpg/tpg_TPI_gate/lfsr_gt ${CIRCUIT_PATH} ${TEST_VEC} ${LFSR_CONFIG_PATH} ${LCP_rate} ${CAPTURE} tgl_gt_tpi.dat
...
rm -f ${CIRCUIT_NAME}_lfsr_pi.dat tgl_gt_tpi.dat tgl_gt_input.dat ff_station_0.dat
